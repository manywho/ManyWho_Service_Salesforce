...
namespace ManyWho.Service.Salesforce.Utils
{
    public class ConnectionManager
    {
        ...
        {
            return ConnectionManager.PostgresConnection(SettingUtils.GetStringSetting(SettingUtils.APP_SETTING_DATASOURCE),
                SettingUtils.GetStringSetting(SettingUtils.APP_SETTING_DATABASE_NAME),
                SettingUtils.GetStringSetting(SettingUtils.APP_SETTING_DATABASE_USERNAME),
                SettingUtils.GetStringSetting(SettingUtils.APP_SETTING_DATABASE_PASSWORD));
        }
